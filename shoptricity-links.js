...
Redirect.prototype = {
	...
	_init : function(exampleUrl, includePattern, redirectUrl, patternType, excludePattern, unescapeMatches, disabled, ID) {
	...
	//__cout : Cc["@mozilla.org/consoleservice;1"].getService(Ci.nsIConsoleService),
	
	_includeMatch : function(url) {
		if (!this._rxInclude) {
			return null;
		}
		//this.__cout.logStringMessage(this._rxInclude);
